// //Car Make & Car model
// final cars = {"Seat": ["Alhambra", "Altea", "Altea XL", "Arosa", "Cordoba", "Cordoba Vario", "Exeo", "Ibiza", "Ibiza ST", "Exeo ST", "Leon", "Leon ST", "Inca", "Mii", "Toledo"],
...
// final Map<String, List<String>> vehicleChecklist = {
//   'Vehicle Particulars': [
...
//     'Brake Pad Condition - Front',
//     'Disc Condition - Front Brake',
//     'Brake Pad Condition - Rear',
//     'Disc Condition - Rear Brake',
//   ],
  
//   'Underhood (Engine Compartment)': [
//     'Oil Level (before oil change)',
//     'Air Filter Control',
//     'Radiator Cap Control',
//     'Brake fluid Level and Condition',
//     'Battery Control',
//     'Engine drive belt(s) condition',
//     'Spark plugs Control (Petrol Engine)',
//   ],
...
//   'Vehicle Interior': [
//     'AC operating and functioning well',
...
// final Map<String, List<String>> autoParts = {
//   'Belt Drive': [
//     'Belt',
...
// final demoServices = ["Tires","Break Pads","Oil Filters","Air filters","Cabin Filters","Batteries","Spark Plugs","Wiper Blade","Bulbs","Wheel Alignment","Tyre Change","AC Maintenance","Fuse"];